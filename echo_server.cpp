...
int main(int argc, char **argv) {
  ...
  int sock_listener = socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
  ...
  // OR
//   inet_pton(AF_INET, "172.17.0.1", &server_addr.sin_addr);
  inet_pton(AF_INET, "127.0.0.1", &server_addr.sin_addr);
//   server_addr.sin_addr = htonl();

//   std::cout << server_addr.sin_addr << std::endl;
